...
<head>
    ...
    <style>
        .parallax{
            background: url('css/images/clubs.jfif') no-repeat center;
...
<body>
    ...
    <section class="clubs-container">
        ...
        <div id="clubs">
            <div class="box">
                <img src="css/images/c1.jpg" alt="" class="club-img">
                <img src="css/images/cricket2.jpg" alt="" class="top club-img">
            ...
            <div class="box">
                <img src="css/images/p1.jpg" alt=""  class="club-img">
                <img src="css/images/p4.jpg" alt=""  class="top club-img">
                <h2 class="h-secondary center">Photography Club</h2>
                <p class="center">Photography is much more than just having a camera and taking pictures. Students in this club have opportunities to hone their skills by understanding and learning about what makes a good photograph. In addition, members of this club will learn how to use state of the art software to edit and enhance photographic images for their own use.</p>
                <button class="box-btn center"><a href="photography.php">View</a></button>
            </div>
            <div class="box">
                <img src="css/images/d3.jpg" alt="" class="club-img">
                <img src="css/images/d5.jpg" alt="" class="top club-img">
        ...
        <div id="clubs">
            <div class="box">
                <img src="css/images/p2.jpg" alt="" class="club-img">
                <img src="css/images/p5.jpg" alt="" class="top club-img">
            ...
            <div class="box">
                <img src="css/images/c2.jpg" alt="" class="club-img">
                <img src="css/images/c3.jpg" alt="" class="top club-img">
            ...
            <div class="box">
                <img src="css/images/f1.jpg" alt="" class="club-img">
                <img src="css/images/f2.jpg" alt="" class="top club-img">
                <h2 class="h-secondary center">Football Club</h2>
                <p class="center">As a club we strive to provide a friendly and structured environment in which the game of football can be fun and enjoyable. We are keen to encourage the values of fair play.The Club programs are designed to provide youth soccer players the opportunity to experience a healthy, safe, and developmentally appropriate environment to learn.</p>
