...
<head>
    ...
    <link rel="stylesheet" href="css/evtStyle.css">
...
<body>
    <div class="container">
        ...
        <div class="parallax">
            ...
            <div class="overlay">
                ...
                <button class="evt-btn"><a href="#evt-slider" style="text-decoration: none; color:white">View Upcoming Events</a></button>
            </div>
        </div>
    </div>

    <section class="event-slider" id="evt-slider">
        <h2>Upcoming Events</h2>
        <button class="pre-btn"><img src="css/images/double-arrow.png" alt=""></button>
        <button class="nxt-btn"><img src="css/images/double-arrow.png" alt=""></button>
            ...
            <div class="event-card">
                <div class="event-img">
                    ...
                    <div class="event-thumb">
                        <img src="css/images/event2.jpg" alt="painting">
                    </div>
                </div>
            </div>
            <div class="event-card">
                <div class="event-img">
                    ...
                    <div class="event-thumb">
                        <img src="css/images/event6.jpg" alt="painting">
                    </div>
                </div>
            </div>
            <div class="event-card">
                <div class="event-img">
                    ...
                    <div class="event-thumb">
                        <img src="css/images/event3.jpg" alt="painting">
                    </div>
                </div>
            </div>
           <div class="event-card">
                <div class="event-img">
                    ...
                    <div class="event-thumb">
                        <img src="css/images/event4.jpg" alt="painting">
                    </div>
                </div>
            </div>
            <div class="event-card">
                <div class="event-img">
                    ...
                    <div class="event-thumb">
                        <img src="css/images/event5.jpg" alt="painting">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="gallery-sec">
        <div class="event-gallery">
            <table class="gallery-table" cellpadding="0" cellspacing="0">
               <tr>
                <td><img src="css/images/gallery/1.jpg" alt=""></td>
                <td><img src="css/images/gallery/2.jpg" alt=""></td>
                <td><img src="css/images/gallery/3.jpg" alt=""></td>
                <td><img src="css/images/gallery/4.jpg" alt=""></td>
                <td><img src="css/images/gallery/5.jpg" alt=""></td>
                <td><img src="css/images/gallery/6.jpg" alt=""></td>
                <td><img src="css/images/gallery/7.jpg" alt=""></td>
               </tr>
               <tr>
                <td><img src="css/images/gallery/8.jpg" alt=""></td>
                <td><img src="css/images/gallery/9.jpg" alt=""></td>
                <td class="gallery-head" rowspan="2" colspan="3"><h1>GALLERY</h1><p>The moments we cherish...</p></td>
                <td><img src="css/images/gallery/10.jpg" alt=""></td>
                <td><img src="css/images/gallery/11.jpg" alt=""></td>
               </tr>
               <tr>
                <td><img src="css/images/gallery/12.jpg" alt=""></td>
                <td><img src="css/images/gallery/13.jpg" alt=""></td>
                <td><img src="css/images/gallery/14.jpg" alt=""></td>
                <td><img src="css/images/gallery/15.jpg" alt=""></td>
               </tr>
               <tr>
                <td><img src="css/images/gallery/16.jpg" alt=""></td>
                <td><img src="css/images/gallery/17.jpg" alt=""></td>
                <td><img src="css/images/gallery/18.jpg" alt=""></td>
                <td><img src="css/images/gallery/19.jpg" alt=""></td>
                <td><img src="css/images/gallery/20.jpg" alt=""></td>
                <td><img src="css/images/gallery/21.jpg" alt=""></td>
                <td><img src="css/images/gallery/22.jpg" alt=""></td>
               </tr>
            </table>
        </div>
    </section>
    ...
    <div class="event-all">
        <div class="event-description">
            <div class="desc-img">
                <img id="one" src="css/images/event2.jpg" alt="">
            </div>
            <div class="desc-info">
        ...
        <div class="event-description">
            <div class="desc-img">
                <img id="two" src="css/images/event6.jpg" alt="">
            </div>
            <div class="desc-info">
        ...
        <div class="event-description">
            <div class="desc-img">
                <img id="three" src="css/images/event3.jpg" alt="">
            </div>
            <div class="desc-info">
                <h2>Cricket Match</h2>
        ...
        <div class="event-description">
            <div class="desc-img">
                <img id="four" src="css/images/event4.jpg" alt="">
            </div>
            <div class="desc-info">
        ...
        <div class="event-description">
            <div class="desc-img">
                <img id="five" src="css/images/event5.jpg" alt="">
            </div>
            <div class="desc-info">
                <h2>Soccer Match</h2>
        ...
        <div class="event-description">
            <div class="desc-img">
                <img id="six" src="css/images/event7.jpg" alt="">
            </div>
            <div class="desc-info">
