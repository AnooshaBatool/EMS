...
<body>
    ...
    <div class="navigation1">
        <img class="imglogo" src="css/images/logoreal.jpg">
    ...
    <div class="imgslider-container-events bg-img" >
        <h1 style="color: white;">LATEST UPCOMING EVENTS!</h1>
        <div class="img1 image1" onmouseover='imgchange("images/f1.jpg")'>
            <img src="css/images/f2.jpg" height="250px" width="250px">
            <div class="text-area">
        ...
        <div class="img1 image2" onmouseover='imgchange("images/paint7.jpg")'>
            <img src="css/images/p2.jpg"  height="250px" width="250px">
            <div class="text-area">
                <p>Match<br>Ocean FC Club<br><br><span>18:00<br> friday August 1st</span></p>
               <br>
            </div>
        ...
        <div class="img1 image3" onmouseover='imgchange("images/d3.jpg")'>
            <img src="css/images/d5.jpg"  height="250px" width="250px">
            <div class="text-area">
    ...
    <div class="slider-container">
      ...
      <div class="slider">
        <div class="slide active">
          <img src="css/images/f2.jpg "   alt="">
          <div class="info">
            <h2>Football Club</h2>
          </div>
        </div>
        <div class="slide">
          <img src="css/images/p2.jpg" alt="">
          <div class="info">
            <h2>Painting Club</h2>
          </div>
        </div>
        <div class="slide">
          <img src="css/images/cricket2.jpg" alt="">
          <div class="info">
            <h2>Cricket Club</h2>
          </div>
        </div>
        <div class="slide">
          <img src="css/images/p1.jpg" alt="">
          <div class="info">
            <h2>Photography Club</h2>
          </div>
        </div>
        <div class="slide">
          <img src="css/images/d3.jpg" alt="">
          <div class="info">
            <h2>Debate Club</h2>
          </div>
        </div>
        <div class="slide">
          <img src="css/images/c4.jpg" alt="">
          <div class="info">
            <h2>Coding Club</h2>
          </div>
        </div>
